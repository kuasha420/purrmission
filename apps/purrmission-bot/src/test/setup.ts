...
process.env.AUDIT_INTEGRITY_KEY =
  process.env.AUDIT_INTEGRITY_KEY ||
  '111102030405060708090a0b0c0d0e0f111102030405060708090a0b0c0d0e0f';
process.env.OUTBOX_INTEGRITY_KEY =
  process.env.OUTBOX_INTEGRITY_KEY ||
  '222202030405060708090a0b0c0d0e0f222202030405060708090a0b0c0d0e0f';
